...
const StudentScreen = ({navigation}) => {
    return (
      ...
      <CustomHeader title= "Student Screen" isHome={false} navigation={navigation}/>
        <View style={styles.container}>
            <Text style={styles.text2}>Welcome student</Text>
            <Text style={{fontSize: 25, color: 'white', textAlign: 'center', marginBottom: 15}}>GRUPOU !</Text>
            <TouchableOpacity style={styles.btn} onPress= { () => navigation.navigate('ContentStudent')}>
