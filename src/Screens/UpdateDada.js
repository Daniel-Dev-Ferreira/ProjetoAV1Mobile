...
function CustomHeader({title, isHome, navigation}){
  ...
  function UpdateDataTeacher({navigation}) {
    return (
      <SafeAreaView style={{ flex: 1 }}>
        <CustomHeader title= "Update Data" isHome={true} navigation={navigation}/>
        <View style={{flex: 1, justifyContent: 'center', alignItems: 'center', backgroundColor: '#1E90FF'}}>
          <Text style={styles.text}>Upate Data</Text>
        </View>
      </SafeAreaView>
    );
  }
  ...
  export default UpdateDataTeacher;
